...
grid_size = 0.06
dataset_path = '/media/ellie/Github/RandLA-Net/data/semantic3d/original_data'
original_pc_folder = join(dirname(dataset_path), 'local')
sub_pc_folder = join(dirname(dataset_path), 'local_{:.3f}'.format(grid_size))
